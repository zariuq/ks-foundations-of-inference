...
namespace KnuthSkilling.Examples.PreciseVsImpreciseGrounded

open Classical
open KnuthSkilling.Probability.BooleanRepresentation
open ProbabilityTheory.Hypercube
...
end KnuthSkilling.Examples.PreciseVsImpreciseGrounded
