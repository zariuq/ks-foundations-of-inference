...
namespace KnuthSkilling.Experimental.RepresentationTheorem.Explorations

open KnuthSkillingAlgebra
open KnuthSkillingAlgebraBase (op ident)
open KnuthSkilling.Additive.Counterexamples
...
end KnuthSkilling.Experimental.RepresentationTheorem.Explorations
