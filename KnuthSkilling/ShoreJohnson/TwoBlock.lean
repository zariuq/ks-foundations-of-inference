import KnuthSkilling.ShoreJohnson.Appendix
...
namespace KnuthSkilling.ShoreJohnson.TwoBlock

open Classical
open scoped BigOperators
open _root_.KnuthSkilling.Information.InformationEntropy
open _root_.KnuthSkilling.ShoreJohnson.Appendix
open _root_.KnuthSkilling.ShoreJohnson.Constraints
open _root_.KnuthSkilling.ShoreJohnson.Inference
open _root_.KnuthSkilling.ShoreJohnson.AppendixMinimizer
open _root_.KnuthSkilling.ShoreJohnson.Objective
...
theorem shift2_twoBlock_inr
  ...
  have hki :
    ...
    intro h
    exact (_root_.KnuthSkilling.ShoreJohnson.Constraints.inlFin_ne_inrFin
      (n := n) (m := m) i k) h.symm
  have hkj :
...
end KnuthSkilling.ShoreJohnson.TwoBlock
