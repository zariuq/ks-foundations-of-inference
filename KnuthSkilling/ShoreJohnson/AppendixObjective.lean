...
This file connects the coordinate-shift calculus (`Appendix.lean`) to the
...
namespace KnuthSkilling.ShoreJohnson.AppendixObjective
...
end KnuthSkilling.ShoreJohnson.AppendixObjective
