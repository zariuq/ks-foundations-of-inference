...
`KnuthSkilling/ShoreJohnson/Bridge.lean`.
-/

namespace KnuthSkilling.ShoreJohnson.Theorem

open Real

open KnuthSkilling.ShoreJohnson.SystemIndependence
...
end KnuthSkilling.ShoreJohnson.Theorem
