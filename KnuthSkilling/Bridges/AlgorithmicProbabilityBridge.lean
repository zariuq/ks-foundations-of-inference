...
import UniversalAI.GrainOfTruth.MeasureTheory.KLDivergenceBridge
...
* `UniversalAI/GrainOfTruth/MeasureTheory/KLDivergenceBridge.lean`
...
namespace KnuthSkilling.Bridges
...
open UniversalAI.GrainOfTruth.MeasureTheory.KLDivergenceBridge
...
theorem solomonoff_normalize_kl_self_nonneg
    (sm : Logic.SolomonoffPrior.Semimeasure)
    (s : Finset Logic.SolomonoffPrior.BinString)
