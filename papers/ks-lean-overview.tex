...
\author{Codex 5.2, Claude 4.5, Zar Goertzel\thanks{This document was drafted collaboratively by humans and AI systems (GPT/Codex, Claude). While formal claims are machine-checked in Lean 4.27.0, prose descriptions may contain human or AI hallucinations. Caveat lector.}}
\date{\today}
...
\begin{itemize}
\item \textbf{Grid proof}: 6,612 lines (ThetaPrime: 3,613 + MultiGrid: 2,999 --- induction machinery, extension lemmas, path independence)
