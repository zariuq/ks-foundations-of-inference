...
See `Mettapedia/ProbabilityTheory/KnuthSkilling/Additive/Counterexamples/ZQuantizedBEmpty.lean`
for a concrete additive model where `B` is empty and `ZQuantized F R (chooseδ …)` fails.

See `Mettapedia/ProbabilityTheory/KnuthSkilling/Additive/Counterexamples/ZQuantizedBNonempty.lean`
