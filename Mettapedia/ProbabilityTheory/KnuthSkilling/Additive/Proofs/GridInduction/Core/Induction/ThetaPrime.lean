...
See:
- `Mettapedia/ProbabilityTheory/KnuthSkilling/Additive/Counterexamples/ZQuantizedBEmpty.lean`
- `Mettapedia/ProbabilityTheory/KnuthSkilling/Additive/Counterexamples/ZQuantizedBNonempty.lean`
-/
...
`Mettapedia/ProbabilityTheory/KnuthSkilling/Additive/Proofs/GridInduction/Core/Induction/Goertzel.lean`, but for the
...
`Mettapedia.ProbabilityTheory.KnuthSkilling.Additive.flip_implies_baseIndexed_B_witness` in
`Mettapedia/ProbabilityTheory/KnuthSkilling/Additive/Proofs/GridInduction/Core/Induction/Goertzel.lean`.
...
this cannot happen:
`Mettapedia/ProbabilityTheory/KnuthSkilling/Additive/Proofs/GridInduction/Core/Induction/Goertzel.lean` proves
