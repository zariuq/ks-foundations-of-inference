...
regularity--see `Mettapedia/ProbabilityTheory/KnuthSkilling/ShoreJohnson/KL.lean`.
-/

namespace Mettapedia.ProbabilityTheory.KnuthSkilling.ShoreJohnson.SystemIndependence
...
end Mettapedia.ProbabilityTheory.KnuthSkilling.ShoreJohnson.SystemIndependence
