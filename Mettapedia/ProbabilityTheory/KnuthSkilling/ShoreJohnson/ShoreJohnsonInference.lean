import Mettapedia.ProbabilityTheory.KnuthSkilling.ShoreJohnson.ShoreJohnsonProof
...
separately in `Mettapedia/ProbabilityTheory/KnuthSkilling/ShoreJohnsonTheorem.lean`. Connecting
...
in `Mettapedia/ProbabilityTheory/KnuthSkilling/ShoreJohnsonConstraints.lean`, and the resulting
assumption bundle for the SJ→KL pipeline is packaged in
`Mettapedia/ProbabilityTheory/KnuthSkilling/ShoreJohnsonPathC.lean`.
-/

namespace Mettapedia.ProbabilityTheory.KnuthSkilling.ShoreJohnsonInference
...
end Mettapedia.ProbabilityTheory.KnuthSkilling.ShoreJohnsonInference
