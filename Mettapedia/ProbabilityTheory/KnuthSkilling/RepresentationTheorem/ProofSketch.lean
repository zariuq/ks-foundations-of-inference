...
1. `.../RepresentationTheorem/ProofSketch.lean` (this file)
2. `.../RepresentationTheorem/Main.lean` (public API)
3. `.../RepresentationTheorem/Globalization.lean` (the globalization construction; “triple family”)
4. `.../RepresentationTheorem/Core/Induction/*` (the B-empty extension step, i.e. the large proof)
...
`.../RepresentationTheorem/Core/SeparationImpliesCommutative.lean`.
