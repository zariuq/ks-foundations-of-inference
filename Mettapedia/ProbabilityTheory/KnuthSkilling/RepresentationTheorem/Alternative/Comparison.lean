...
(`RepresentationTheorem/Main.lean`) and the `Θ` produced by the Dedekind-cuts proof
(`RepresentationTheorem/Alternative/Main.lean`) coincide up to a positive scalar.
