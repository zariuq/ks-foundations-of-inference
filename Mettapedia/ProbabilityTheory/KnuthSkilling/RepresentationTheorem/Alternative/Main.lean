...
import Mettapedia.ProbabilityTheory.KnuthSkilling.RepresentationTheorem.Alternative.DirectCuts
...
`Mettapedia.ProbabilityTheory.KnuthSkilling.RepresentationTheorem.Alternative.DirectCuts`
...
- the grid/induction proof as the mainline (`RepresentationTheorem/Main.lean`), and
