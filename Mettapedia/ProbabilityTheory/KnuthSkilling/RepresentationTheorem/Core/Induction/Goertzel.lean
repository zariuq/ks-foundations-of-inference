...
1. `ChooseδBaseAdmissible` and `extend_grid_rep_with_atom` in
   `Mettapedia/ProbabilityTheory/KnuthSkilling/RepresentationTheorem/Core/Induction/ThetaPrime.lean`
...
4. Counterexamples in `Mettapedia/ProbabilityTheory/KnuthSkilling/RepresentationTheorem/Counterexamples/`
-/
...
`Mettapedia/ProbabilityTheory/KnuthSkilling/RepresentationTheorem/Core/MultiGrid.lean`
...
- `NewAtomCommutes` is not derivable from the base `KnuthSkillingAlgebra` axioms; see
  `Mettapedia/ProbabilityTheory/KnuthSkilling/RepresentationTheorem/Counterexamples/NewAtomCommutesNotDerivable.lean`.
- `C_strict0` is also not derivable from the “B-empty accuracy” core alone: there is a concrete
  ...
  `Mettapedia/ProbabilityTheory/KnuthSkilling/RepresentationTheorem/Counterexamples/CStrict0Fails.lean`.
...
/-!
`ChooseδBaseAdmissible` is defined in `RepresentationTheorem/Core/Induction/ThetaPrime.lean` and
imported at
...
To keep `RepresentationTheorem` building warning-free, the work-in-progress proof is commented out here.
