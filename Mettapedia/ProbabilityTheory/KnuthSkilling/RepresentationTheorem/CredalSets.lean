...
**Note**: The main K&S formalization (`RepresentationTheorem/Main.lean`) works in Lean's foundation
...
namespace Mettapedia.ProbabilityTheory.KnuthSkilling.RepresentationTheorem.CredalSets
...
end Mettapedia.ProbabilityTheory.KnuthSkilling.RepresentationTheorem.CredalSets
