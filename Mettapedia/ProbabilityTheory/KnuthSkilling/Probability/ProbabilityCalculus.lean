...
#check Mettapedia.ProbabilityTheory.KnuthSkilling.Probability.ProbabilityCalculus.sumRule
#check Mettapedia.ProbabilityTheory.KnuthSkilling.Probability.ProbabilityCalculus.bayesTheorem
```
-/

namespace Mettapedia.ProbabilityTheory.KnuthSkilling.Probability.ProbabilityCalculus
...
abbrev sumRule := @Mettapedia.ProbabilityTheory.KnuthSkilling.Probability.sum_rule
...
abbrev productRule := @Mettapedia.ProbabilityTheory.KnuthSkilling.Probability.product_rule_ks
...
abbrev bayesTheorem := @Mettapedia.ProbabilityTheory.KnuthSkilling.Probability.bayes_theorem_ks
...
abbrev complementRule := @Mettapedia.ProbabilityTheory.KnuthSkilling.Probability.complement_rule
...
instance instProbabilityCalculusOfCoxConsistency
    ...
    {v : Valuation α} (hC : Mettapedia.ProbabilityTheory.KnuthSkilling.Probability.CoxConsistency α v) :
    ProbabilityCalculusClass α v where
  sum_rule' := fun h =>
    Mettapedia.ProbabilityTheory.KnuthSkilling.Probability.sum_rule v hC h
  complement_rule' := fun h_disj h_top =>
    Mettapedia.ProbabilityTheory.KnuthSkilling.Probability.complement_rule v hC _ _ h_disj h_top

end Mettapedia.ProbabilityTheory.KnuthSkilling.Probability.ProbabilityCalculus
