...
namespace Mettapedia.ProbabilityTheory.KnuthSkilling.Probability
...
- `Mettapedia.ProbabilityTheory.KnuthSkilling.Multiplicative.Main` (via the product equation)
- `Mettapedia.ProbabilityTheory.KnuthSkilling.Multiplicative.DirectProof` (Lean-friendly direct route)
...
end Mettapedia.ProbabilityTheory.KnuthSkilling.Probability
