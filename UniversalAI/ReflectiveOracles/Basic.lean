import Computability.OracleTMReal
import UniversalAI.ReflectiveOracles.DirectionMismatch
...
- `Computability.CantorSpace` for fair coin measure
- `Computability.OracleTMReal` for oracle TM with query tracking
...
namespace UniversalAI.ReflectiveOracles

-- Re-export key types from OracleTMReal
export Computability (Oracle OTMIndex oracleOutputProbBounded
...
See `Computability.nonCircular_at_position` for the proof.
-/
...
end UniversalAI.ReflectiveOracles
